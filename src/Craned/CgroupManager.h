...
class CgroupV1 : public Cgroup, public CgroupInterface {
 public:
...
class CgroupV2 : public Cgroup, public CgroupInterface {
 public:
...
class CgroupManager {
 ...
 private:
  ...
  std::unique_ptr<CgroupInterface> CreateOrOpen_(const std::string &cgroup_string,
